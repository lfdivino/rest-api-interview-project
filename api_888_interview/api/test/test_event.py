...
class TestEventUsingRoutes(unittest.TestCase):
    ...
    @patch('api.src.database.db_event.DBEvent.create_event')
    ...
    @patch('api.src.database.db_event.DBEvent.select_event_by_id')
    ...
    @patch('api.src.database.db_odds.DBOdds.update_odds')
    @patch('api.src.database.db_event.DBEvent.select_event_by_id')
    ...
    @patch('api.src.database.db_match.DBMatch.select_event_by_name')
    ...
    @patch('api.src.database.db_match.DBMatch.select_event_by_sport')
    ...
    @patch('api.src.database.db_match.DBMatch.select_events')
